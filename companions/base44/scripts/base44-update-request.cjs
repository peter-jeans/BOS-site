// Generated by scripts/generate_base44_update_commonjs.mjs; edit the .mjs source.
// Source SHA-256: 2df039acf8b5c8bf49e7762bd55ce312262453d0cf8753c9c14bdf8013afee87
...
async function prepareBase44UpdateRequest({ store, binding, baseline, transport = 'INSTALLED_PLAN_REFERENCE', aicontrol_revision }) {
...
async function uploadBase44UpdateRequest({ ticket, serviceOrigin, fetchImpl = globalThis.fetch, ...input }) {
...
async function prepareBase44ActivationRequest({ binding, plan_ref, approval, readback_bytes, store } = {}) {
...
async function uploadBase44ActivationReadback({ ticket, serviceOrigin, fetchImpl = globalThis.fetch, ...input }) {
...
async function submitBase44UpdateRequest({ callTool, ...input }) {
...
module.exports = { prepareBase44UpdateRequest, uploadBase44UpdateRequest, prepareBase44ActivationRequest, uploadBase44ActivationReadback, submitBase44UpdateRequest };
